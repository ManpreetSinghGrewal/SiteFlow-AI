...
const ChatMessageComponent = ({ message, onRegenerate, onPreview, isLoading }: Props) => {
        ...
        {!isUser && containsHtml && !isLoading && (
          <div className="flex items-center gap-2 mt-4 pt-3 border-t border-border">
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-medium text-primary hover:opacity-80 transition-colors px-3 py-1.5 rounded-lg bg-primary/10 hover:bg-primary/15"
            >
